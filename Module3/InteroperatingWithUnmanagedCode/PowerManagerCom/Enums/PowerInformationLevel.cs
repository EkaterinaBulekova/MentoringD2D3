...
namespace PowerManager
{
    ...
    enum POWER_INFORMATION_LEVEL : Int32
    {
        ...
        /// The lpInBuffer parameter must point to a bool value indicating the desired request. If the value is TRUE, the hibernation file is reserved; if the value is FALSE, the hibernation file is removed.
        /// </summary>
