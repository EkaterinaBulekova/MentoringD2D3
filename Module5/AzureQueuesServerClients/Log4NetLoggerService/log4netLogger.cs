...
namespace Log4NetLoggerService
{
    public class Log4NetLogger : ILogger
    {
        ...
        private readonly Func<string, string> EncounteredUnknownLogLevel =
             (logLevel) => $"Encountered unknown log level {logLevel}, writing out as Info.";
            ...
            if (!string.IsNullOrEmpty(message) || exception != null)
            {
                switch (logLevel)
                {
                    ...
                    case LogLevel.Warning:
                        ...
                        break;
                    default:
                        _log.Warn(EncounteredUnknownLogLevel(logLevel.ToString()));
